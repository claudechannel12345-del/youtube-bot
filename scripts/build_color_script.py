...
drive TTS pacing/pauses; each section maps to cutaway scene families + registry assets. The v1
critique fixes are applied here: intro discovery hook, split staccato lines + transition pauses,
simplified romantic-red, section-9 suspense restructure, real outro, new assets (mandrill/finch/
person_female/heart/gavel). Run: py -3 scripts/build_color_script.py
"""
import json
import os
...
SECTIONS = [
    {  # 1 - COLD OPEN + personal discovery hook
        ...
        "sent": [
            ...
            ("Not the fighting.", "punch"),
            ("Just the color.", "transition"),
        ...
        "beats": [
            ...
            {"type": "emphasize", "s": [6, 9], "text": "JUST THE COLOR", "subjects": ["light"], "importance": "high"},
            {"type": "establish", "s": [10, 11], "text": "FROM A TEST", "subjects": ["paperwork"], "importance": "medium"},
            {"type": "emphasize", "s": [12, 14], "text": "DEEPER THAN SPORTS", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 2 - red in nature (mandrill + finch assets)
        ...
        "sent": [
            ...
            ("That color is wired straight to his testosterone.", "neutral"),
            ...
            ("Across primates, birds, and fish,", "neutral"),
            ("red keeps meaning the same thing.", "weighty"),
            ("Back off.", "punch"),
        ...
        "beats": [
            ...
            {"type": "establish", "s": [3, 5], "text": "WIRED IN, NOT CHOSEN", "subjects": ["mandrill"], "importance": "high"},
            {"type": "establish", "s": [6, 6], "text": "THE REDDER BIRD WINS", "subjects": ["finch"], "importance": "medium"},
            {"type": "emphasize", "s": [7, 9], "text": "BACK OFF", "subjects": ["mandrill"], "importance": "high"},
            {"type": "emphasize", "s": [10, 11], "text": "DID WE EVER STOP?", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 3 - Olympic pattern (stats)
        ...
        "sent": [
            ...
            ("Here's the crucial part.", "curious"),
            ("In these sports, the athletes are handed red or blue gear at random.", "neutral"),
            ("Nobody picks.", "punch"),
            ...
            ("A coin that lands red sixty-two percent of the time", "neutral"),
            ("isn't a fair coin.", "weighty"),
            ("Something was loading it.", "transition"),
        ],
        "beats": [
            {"type": "establish", "s": [0, 5], "text": "RED OR BLUE, AT RANDOM", "subjects": ["person", "person"], "colors": ["accent", "blue"], "importance": "medium"},
            {"type": "stat_pop", "s": [6, 9], "text": "RED WON 55%", "subjects": [], "importance": "high"},
            {"type": "stat_pop", "s": [10, 10], "text": "62% IN CLOSE FIGHTS", "subjects": [], "importance": "high"},
            {"type": "emphasize", "s": [11, 13], "text": "NOT A FAIR COIN", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 4 - two suspects
        "key_phrase": "TWO SUSPECTS",
        "sent": [
            ("There were two suspects.", "weighty"),
            ("Suspect one: the color changes the fighters.", "neutral"),
            ("Maybe red makes you feel a little more dangerous, and makes your opponent flinch.", "neutral"),
            ("Suspect two: the color changes the person keeping score.", "neutral"),
            ("The fighters are identical.", "punch"),
            ("The referee is the one who's biased.", "weighty"),
        ...
        "beats": [
            {"type": "compare", "s": [0, 5], "text": "THE FIGHTER  or  THE JUDGE", "subjects": ["person", "person"], "colors": ["accent", "ink"], "importance": "high"},
            {"type": "emphasize", "s": [6, 7], "text": "FREEZE THE FIGHTERS", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 5 - the color-swap (the crack)
        ...
        "sent": [
            ...
            ("Thirteen percent more points,", "neutral"),
            ("for being wrapped in red.", "weighty"),
        ...
        "beats": [
            ...
            {"type": "stat_pop", "s": [6, 8], "text": "RED:  +13%", "subjects": [], "importance": "high"},
            {"type": "emphasize", "s": [9, 10], "text": "IT WAS THE JUDGE", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 6 - black uniforms
        "key_phrase": "WHAT YOU WORE",
        "sent": [
            ("And once you know to look for it, you see it everywhere.", "transition"),
            ("Years earlier, researchers dug through penalty records in pro football and hockey.", "neutral"),
            ("Teams that wore black got penalized more.", "neutral"),
            ("Not occasionally.", "punch"),
            ("Consistently.", "weighty"),
            ("Two teams even switched their jerseys to black partway through their history,", "neutral"),
            ("and their penalties jumped right after.", "weighty"),
            ...
            ("Red flatters you to the judge.", "neutral"),
            ("Black incriminates you.", "punch"),
            ("Either way, they're not scoring what you did.", "neutral"),
            ("They're scoring what you wore.", "transition"),
        ],
        "beats": [
            {"type": "compare", "s": [0, 6], "text": "WHITE  vs  BLACK", "subjects": ["person", "person"], "colors": ["muted", "ink"], "importance": "high"},
            {"type": "emphasize", "s": [7, 9], "text": "SAME PLAY, MORE FLAGS", "subjects": ["light"], "importance": "high"},
            {"type": "emphasize", "s": [10, 13], "text": "THEY SCORE THE JERSEY", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 7 - courtroom (gavel)
        ...
        "sent": [
            ...
            ("Defendants who look the part - the wrong tattoos, the wrong clothes -", "neutral"),
            ("get judged more dangerous, and sentenced harder, for the same crime.", "weighty"),
            ("Lawyers have known this forever.", "neutral"),
            ("It's why they put defendants in soft grays and quiet collars.", "neutral"),
            ("Never red.", "punch"),
        ...
        "beats": [
            ...
            {"type": "emphasize", "s": [3, 8], "text": "DRESSED FOR THE JURY", "subjects": ["person"], "colors": ["muted"], "importance": "medium"},
            {"type": "emphasize", "s": [9, 11], "text": "SOFTER SCIENCE - BE HONEST", "subjects": ["light"], "importance": "high"},
            {"type": "emphasize", "s": [12, 13], "text": "IT JUST HIDES BETTER", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 8 - romantic red (simplified + person_female + heart)
        ...
        "sent": [
            ...
            ("Around 2008, studies claimed a woman in red looked more attractive to men.", "neutral"),
            ("And the men had no idea it was even happening.", "weighty"),
            ("It's a great story.", "neutral"),
            ("But here's the catch.", "curious"),
            ("When other scientists tried to repeat it, it mostly fell apart.", "weighty"),
            ("So I'm not going to promise you that red fixes your dating life.", "neutral"),
            ("Honestly, nobody's sure this one is even real.", "weighty"),
            ("And that's kind of the point.", "neutral"),
            ("A good color story is so tempting,", "neutral"),
            ("even the scientists chasing it can get fooled.", "transition"),
        ],
        "beats": [
            {"type": "compare", "s": [0, 3], "text": "RED  =  ATTRACTIVE?", "subjects": ["person_female", "person"], "colors": ["accent", "ink"], "importance": "high"},
            {"type": "cutaway_gag", "s": [4, 5], "text": "IT FELL APART", "subjects": ["heart"], "importance": "high"},
            {"type": "emphasize", "s": [6, 10], "text": "EVEN SCIENTISTS GET FOOLED", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 9 - the twist (suspense restructured)
        ...
        "sent": [
            ...
            ("Today, red wins about fifty point five percent.", "weighty"),
            ("A coin flip again.", "punch"),
            ...
            ("And the moment the biased judge stepped back,", "neutral"),
            ("the magic evaporated.", "weighty"),
            ...
            ("Which means the advantage was never really in the red.", "ominous"),
        ...
        "beats": [
            ...
            {"type": "establish", "s": [7, 12], "text": "THE MACHINE COUNTS", "subjects": ["counter"], "importance": "medium"},
            {"type": "emphasize", "s": [13, 16], "text": "IT DIED WITH THE JUDGE", "subjects": ["light"], "importance": "high"},
            {"type": "emphasize", "s": [17, 18], "text": "IT WAS IN US", "subjects": ["light"], "importance": "high"},
        ],
    },
    {  # 10 - closer + outro hook
        ...
        "sent": [
            ...
            ("Mostly, we judge the wrapping - and then invent a reason that sounds like merit.", "weighty"),
            ...
            ("Most of the time, it's just you,", "neutral"),
            ("a color you barely chose,", "neutral"),
            ("and someone across the table who's certain they're being fair.", "weighty"),
            ("So here's the thing worth chewing on.", "curious"),
            ("If a single color can quietly bend a trained referee,", "neutral"),
            ("what else are you being scored on that you've never once noticed?", "transition"),
        ],
        "beats": [
            ...
            {"type": "compare", "s": [6, 8], "text": "YOU  vs  THE TABLE", "subjects": ["person", "person"], "colors": ["accent", "ink"], "importance": "medium"},
            {"type": "emphasize", "s": [9, 11], "text": "WHAT ELSE AREN'T YOU SEEING?", "subjects": ["light"], "importance": "high"},
        ],
    },
]
