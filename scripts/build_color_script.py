...
SECTIONS = [
    ...
    {  # 4 - two suspects
        ...
        "sent": [
            ...
            ("Suspect one.", "weighty"),
            ("The color changes the fighters themselves.", "neutral"),
            ("Maybe red makes you feel more dangerous, and makes your opponent flinch.", "neutral"),
            ("Suspect two.", "weighty"),
            ("The color changes the person keeping score.", "neutral"),
            ("Either way, the fighters are identical. The referee is the one who's biased.", "weighty"),
            ("In a real match, both could be true at once, and you would never tell them apart.", "neutral"),
            ("You would need a way to freeze the fighters, and test only the judge.", "transition"),
        ],
        "beats": [
            {"type": "compare", "s": [0, 5], "text": "THE FIGHTER  or  THE JUDGE", "subjects": ["person", "person"], "colors": ["accent", "ink"], "importance": "high"},
            {"type": "emphasize", "s": [6, 8], "text": "FREEZE THE FIGHTERS", "subjects": ["light"], "importance": "high"},
        ],
    },
...
def build():
    ...
    return {
        ...
        "description": (
            ...
            "Music: \"Wholesome\" by Kevin MacLeod (incompetech.com) - Licensed under Creative Commons: "
            "By Attribution 4.0 (http://creativecommons.org/licenses/by/4.0/)"
        ),
